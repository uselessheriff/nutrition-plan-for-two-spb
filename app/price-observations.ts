...
export const priceHistoryDataNotes = [
  "Сообщено 06.09: яйца 10 шт. за 130 ₽ = 13 ₽/шт. Бренд и дата покупки неизвестны, поэтому это ориентир без утверждения динамики того же товара. Набор для выпечки 780 ₽ не разбивается на цены компонентов.",
