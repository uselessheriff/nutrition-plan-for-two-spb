...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    description:
      "Действующий бюджет, меню, подробные рецепты, закупки, остатки и история цен для двоих в Санкт-Петербурге.",
    openGraph: {
      title: "Питание на месяц для двоих",
      description:
        "Бюджет 25 000 ₽: факт прошедших недель, текущая неделя, архив рецептов, закупки и память цен.",
      type: "website",
      url: origin,
      images: [
        {
